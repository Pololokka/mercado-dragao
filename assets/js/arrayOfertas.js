const produtosOferta =  JSON.parse(localStorage.getItem('arrayOfertas')) || [
    {
        id : "0",
...
function salvaOfertas() {
    const arrayOfertasJSON = JSON.stringify(produtosOferta);
    localStorage.setItem('arrayOfertas', arrayOfertasJSON);
}
